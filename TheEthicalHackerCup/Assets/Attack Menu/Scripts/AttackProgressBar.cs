...
public class AtttackProgressBar : MonoBehaviour {
	[Header("Colors")]
    ...
    [Range(0, 360)]  private float startAngle = 90;
    [Range(0, 360)]  private float endAngle = 270;
	...
	private void drawingProgressBar() {
        for (int i = 0; i < numSegments; i++) {
